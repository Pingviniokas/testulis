                    ...
                    <div className="mobile-menu-content">
                        <div className="px-4 pt-2 pb-6 space-y-2">
                            ...
                            <div className={`space-y-2 ${isMobileMenuOpen ? 'mobile-links-enter' : ''}`}>
                                <Link href="/apie-mus" className="block px-3 py-2 text-base font-semibold text-gray-900 hover:text-red-600 transition-colors duration-300">
                                    Apie Mus
                                </Link>
                                <Link href="/kontaktai" className="block px-3 py-2 text-base font-semibold text-gray-900 hover:text-red-600 transition-colors duration-300">
                                    Kontaktai
                                </Link>
                                <div className="pt-4">
